...
use crate::lobject::{AbsLineInfo, LocVar, Proto, TString, TValue, Table, Upvaldesc, Value};
use crate::lopcodes::{
...
unsafe fn primaryexp(
    ...
    match (*ls).t.token {
        ...
        _ => luaX_syntaxerror(ls, "unexpected symbol"),
    }
}
...
unsafe fn forstat(
    ...
    match (*ls).t.token {
        ...
        _ => return luaX_syntaxerror(ls, "'=' or 'in' expected"),
    }
