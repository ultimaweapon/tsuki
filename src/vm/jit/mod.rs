...
use super::{
    OP_CALL, OP_CLOSURE, OP_EQK, OP_GETTABUP, OP_LFALSESKIP, OP_LOADI, OP_LOADK, OP_LOADTRUE,
    OP_MOVE, OP_NEWTABLE, OP_RETURN, OP_VARARG, OP_VARARGPREP, luaV_equalobj, luaV_finishget,
};
